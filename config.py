...
# ============================================================================
# Backend API キー（ComfyUIノード → FastAPI通信）
# ============================================================================
API_KEY = os.getenv("API_KEY", "dev-key-12345")
ALCHEMY_API_URL = os.getenv("ALCHEMY_API_URL", "http://localhost:8000/api/optimize_loras")
ALCHEMY_API_TIMEOUT = int(os.getenv("ALCHEMY_API_TIMEOUT", "30"))  # ComfyUI Proxy の API タイムアウト
...
# Retry 間隔の乗数（Exponential Backoff）
RETRY_BACKOFF_FACTOR = float(os.getenv("RETRY_BACKOFF_FACTOR", "2.0"))

# Retry 対象の HTTP ステータスコード
